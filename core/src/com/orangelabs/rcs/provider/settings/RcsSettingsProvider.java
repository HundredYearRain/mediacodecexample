...
public class RcsSettingsProvider extends ContentProvider {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            addParameter(db, RcsSettingsData.USERPROFILE_IMS_USERNAME, 			"+34667265212");
            addParameter(db, RcsSettingsData.USERPROFILE_IMS_DISPLAY_NAME, 		"mtk33054");
            addParameter(db, RcsSettingsData.USERPROFILE_IMS_HOME_DOMAIN, 		"ims.vodafone.es");
            addParameter(db, RcsSettingsData.USERPROFILE_IMS_PRIVATE_ID, 		"214018904185301@ims.mnc001.mcc214.3gppnetwork.org");
            addParameter(db, RcsSettingsData.USERPROFILE_IMS_PASSWORD, 			"1800");
            addParameter(db, RcsSettingsData.USERPROFILE_IMS_REALM,		 		"ims.vodafone.es");
		    addParameter(db, RcsSettingsData.IMS_PROXY_ADDR_MOBILE,				"rcs.ims.vodafone.es");
		    addParameter(db, RcsSettingsData.IMS_PROXY_PORT_MOBILE,				"5060");
		    addParameter(db, RcsSettingsData.IMS_PROXY_ADDR_WIFI,				"rcs.ims.vodafone.es");
            ...
            addParameter(db, RcsSettingsData.COUNTRY_CODE,						"+34");
            ...
            addParameter(db, RcsSettingsData.SIP_DEFAULT_PROTOCOL_FOR_MOBILE,   ListeningPoint.TLS);
            addParameter(db, RcsSettingsData.SIP_DEFAULT_PROTOCOL_FOR_WIFI,     ListeningPoint.TLS);
            ...
            addParameter(db, RcsSettingsData.SECURE_MSRP_OVER_WIFI,	     		RcsSettingsData.TRUE);
